...
import com.heavendevelopment.mantvida2017.DiaAtualDecorator;
import com.heavendevelopment.mantvida2017.Dominio.EstadoLeitura;
import com.heavendevelopment.mantvida2017.Dominio.Leitura;
import com.heavendevelopment.mantvida2017.LeituraDecoratorNaoRealizadoDecorator;
import com.heavendevelopment.mantvida2017.LeituraDecoratorRealizadoDecorator;
...
public class PlanoLeituraMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String dataLeitura = diaHoje + " de " + chooseMonthName(mesHoje) + " de " + 2017;
    ...
    private void changeColorOfDaysDecorator(){
        ...
        leituraHoje.add(new CalendarDay(2017,5,diaAtual));
        ...
        for(int i = 0; i < listEstadoLeitura.size(); i++){
            ...
            calendarDay = new CalendarDay(2017,objEstadoLeitura.getMes(),objEstadoLeitura.getDia());
