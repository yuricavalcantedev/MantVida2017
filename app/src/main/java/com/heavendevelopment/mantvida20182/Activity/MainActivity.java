...
import com.heavendevelopment.mantvida20182.Service.EventoService;
...
public class MainActivity extends AppCompatActivity
    ...
    private FloatingActionButton fabLeitura;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabLeitura = (FloatingActionButton) findViewById(R.id.fab_main);
        tvTituloEvento = (TextView) findViewById(R.id.tv_main_titulo_evento);
        tvDataEvento = (TextView) findViewById(R.id.tv_main_data_evento);
        tvDescricaoEvento = (TextView) findViewById(R.id.tv_main_descricao_evento);
        ...
        try{
            ...
            fabLeitura.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CoordinatorLayout coordinatorLayout = (CoordinatorLayout) findViewById(R.id.coorLayoutMain);
                    Snackbar.make(coordinatorLayout,"Função ainda não disponível",Snackbar.LENGTH_SHORT).show();
